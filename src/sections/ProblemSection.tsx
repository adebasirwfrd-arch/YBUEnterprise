...
const problems = [
    {
        ...
        title: "Lost Tenders (CSMS Failure)",
        description:
            "Tier-2 & Tier-3 contractors consistently lose bids to BUMN/Multinational projects due to low CSMS scores caused by disorganized documentation and manual compliance tracking.",
        stat: "70%",
        statLabel: "Tender losses from poor CSMS",
    },
    {
        icon: (
            <svg className="w-10 h-10" viewBox="0 0 40 40" fill="none">
        ...
        description:
            "Companies face billions in penalties and risk \"PROPER Merah/Hitam\" ratings from KLHK. Manual data collection for emissions, waste, and incidents is prone to manipulation and human error.",
        stat: "Rp 5B+",
        statLabel: "Average annual penalties",
    },
    {
        icon: (
            <svg className="w-10 h-10" viewBox="0 0 40 40" fill="none">
        ...
        description:
            "Tier-1 ERPs like SAP demand billions in CapEx, are too rigid for field conditions, and completely fail in mining/offshore areas with limited internet connectivity.",
        stat: "Rp 2B+",
            ...
            <div className="relative z-10 mx-auto max-w-6xl px-6">
                <AnimatedSection className="text-center mb-16">
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">
                        The <span className="text-red-400">Bleeding Neck</span>
                    </h2>
                    <p className="max-w-2xl mx-auto text-gray-400 text-lg">
                        Heavy industries in Indonesia are hemorrhaging resources from three
                        critical failure points that generic solutions cannot address.
                    </p>
                </AnimatedSection>
